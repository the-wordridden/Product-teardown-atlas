...
|---|---|
| **Product** | Notion |
| **Stage** | 1 — Source discovery and collection (passes 1, 1b, 1c, 1d) |
...
| **Status** | **Passes 1–1d complete. Gate assessment in `05-stage-1-gate.md`, revised after 1d** |
| **Sources verified (opened and inspected)** | **22**, including **4 direct observations** |
| **Sources attempted and blocked** | 8 |

### Pass 1d — founding-era users, the block limit's history, Reddit blocked (2026-09-22)

Sources **NOT-S018** and **NOT-S019**, both contemporaneous Hacker News corpora. Three gaps closed or narrowed:

- **JTBD is no longer a gap.** The January 2019 launch thread carries first-hand accounts naming what Notion replaced and why, in users' own words [S018]: Asana and Jira ("Switched to it after getting annoyed with Asana and not wanting to use something like Jira"), Jira again ("We use them in lieu of JIRA"), Evernote ("For me, Notion replaced Evernote and I haven't looked back"), OneNote, Google Docs and Dropbox Paper. Pull, anxiety and habit are all quotable.
- **The block limit's history is evidenced without the archive.** In May 2020 Notion removed the block cap for individuals. A commenter quotes Notion's FAQ of the day: "You can downgrade to the free plan for which the number of blocks is not limited anymore" and "What if I'm already paying for the old Personal Plan? You've been automatically upgraded to our new Personal Pro Plan at no extra cost!", establishing a prior paid Personal plan at $4/month [S019]. Two users describe the pre-2020 cap by its number and its defining cruelty: "hit some arbitrary 1000 block limit that no matter what I deleted I couldn't get rid of". **So the same 1,000-block, deletion-proof mechanic that applies to multi-member free workspaces today [S002] applied to individuals until May 2020.** The gate's open question 5 is answered.
- **The export friction is now corroborated across two independent accounts, two years apart.** 2019: "I feel it's hard to get stuff out of it" [S018]. 2021: a paying customer's export silently failing for three months, support citing a backlog [S009]. Same friction, independent reporters, 2019 and 2021. This lifts the switching-cost candidate from one anecdote to two.

**Reddit is unavailable in this environment** (HTTP 403, and the browser pane refuses the domain), so the planned r/Notion sweep could not run (X006). The 2019 and 2020 HN corpora cover the same class of evidence and are stronger, being contemporaneous and higher-engagement.
...
| ID | Source | Date | Serves | Notes |
|---|---|---|---|---|
| **NOT-S018** | HN 18904648, "Notion – All-in-one workspace for notes, tasks, wikis, and databases" (970 pts, 479 comments); 40 top-level comments retained in `_extracted/hn-launch-2019.txt` | 2019-01-14 | **USE (lived experience)**, CMP (practitioner framing), HIS | What it displaced, first-hand: "We use it to keep track of all of our tasks and projects. Switched to it after getting annoyed with Asana and not wanting to use something like Jira. We love how freeform it is and allowed us to create a workflow that fit us"; "We use them in lieu of JIRA"; "For me, Notion replaced Evernote and I haven't looked back"; "I used to draft emails in an unorganized OneNote notebook"; "easier for me to navigate/structure than it is in google docs". A user description of the block model that matches the API: "Everything is a 'block' and blocks can be nested and attached together to create pages/subpages, tables, kanban boards, calendars"; and the positioning, in a user's words, as "the perfect balance between strict JIRA/PM tools and completely unstructured wikis/text files". Frictions named at launch: export ("I feel it's hard to get stuff out of it"), import from Evernote ("can't imagine porting all my notes"), speed, no Linux client, no API, the emailed one-time-code login. **A user had already built notionpages.com "for people to share their Notion pages"** four years before Notion's own gallery relaunch. |
| **NOT-S019** | HN 23236786, "Notion for everyone" (1,044 pts, 454 comments); 45 comments retained in `_extracted/hn-free-tier-2020.txt` | 2020-05-19 | **PRC (historical)**, USE | Contemporaneous with Notion removing the personal free-tier block cap. A commenter quotes Notion's FAQ: "You can downgrade to the free plan for which the number of blocks is not limited anymore"; "What if I'm already paying for the old Personal Plan? You've been automatically upgraded to our new Personal Pro Plan at no extra cost!"; the prior Personal plan is referred to as $4/month. Lived accounts of the pre-2020 cap: "hit some arbitrary 1000 block limit that no matter what I deleted I couldn't get rid of"; "we're about to hit the 1000 block limit" on a workspace shared with a spouse; "The 'blocks' limit always felt arbitrary on Free, so I never really got into it". Counter-voice on the product's core trade: "Flexibility of blocks is a cognitive overhead for most folks in my team. They would rather prefer more constrained and opinionated approaches like Trello… Notion is currently a jack of all trades and master of none." Lock-in anxiety: "if they ever shut, stop innovating, or are outshined by a competitor, I don't fancy the idea of moving everything". |
...
| NOT-X004 | web.archive.org CDX for notion.so/pricing (2018–2024) | **"Internet Archive: Temporarily Offline"**, four attempts across two teardowns | **Superseded for the block limit** by S019, which carries a contemporaneous quotation of Notion's own FAQ. AI add-on history (open question 15) still unevidenced |
| NOT-X006 | r/Notion, for first-hand adoption and abandonment accounts | **Blocked in this environment:** reddit.com returns HTTP 403 to direct requests and the browser pane refuses the domain on policy grounds | Covered instead by S018 and S019, which are contemporaneous, higher-engagement and quotable |
